...
PAGERDUTY_API_KEY = "XYZ"  # Your PagerDuty API key
USER_ID = "XYZ"  # Your PagerDuty User ID
...
parser.add_argument("--cast", help=f'Name of cast device (default: "{CAST_NAME}")', default=CAST_NAME)
